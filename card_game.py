...
card_images = [
    "dazai.png", "anyaa.png", "eren.png", "naruto.png",
    "dazai.png", "anyaa.png", "eren.png", "naruto.png",
    "nezuko.png", "nezuko.png", "levi.png", "shinchan.png",
    "mikey.png", "mikey.png", "levi.png", "shinchan.png"
]
...
class StartPage:
    def __init__(self, root):
        ...
        self.background_image = tk.PhotoImage(file="gamecover2.png")
...
class CardGame:
    def __init__(self, root):
        ...
        self.background_image = tk.PhotoImage(file="gamecover3.png")
...
if __name__ == "__main__":
    ...
    back_image = tk.PhotoImage(file="cover.png")
